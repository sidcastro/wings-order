...
ActiveRecord::Schema.define(version: 20151214003528) do
  ...
  create_table "flavors", id: :serial, force: :cascade do |t|
    t.string "name", null: false
  end

  create_table "order_flavors", id: :serial, force: :cascade do |t|
    t.integer "wing_order_id", null: false
    t.integer "flavor_id", null: false
  end

  create_table "wing_orders", id: :serial, force: :cascade do |t|
